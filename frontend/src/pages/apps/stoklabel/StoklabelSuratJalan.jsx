  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Surat Jalan</h1>
          <p className="text-gray-600 dark:text-slate-400 mt-1">Kelola surat jalan pengiriman</p>
        </div>
        <Button
          app="stoklabel"
          variant="primary"
