      ...
      <Card className="p-6">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-2 bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-600 rounded-lg text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-stoklabel-500 dark:focus:ring-stoklabel-400 focus:border-transparent transition-all duration-200"
          />
        </div>
      </Card>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center p-4 bg-gray-50 dark:bg-slate-900/50 rounded-lg">
                <input
                  ...
                  className="w-4 h-4 rounded border-gray-300 dark:border-slate-600 text-stoklabel-600 focus:ring-stoklabel-500"
                />
