    ...
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600 dark:text-slate-400 mt-1">Kelola pengguna aplikasi Stoklabel</p>
        </div>
        <Button
          app="stoklabel"
          variant="primary"
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <div className="flex items-center justify-end space-x-2">
                      <button
                        ...
                        className="text-stoklabel-600 hover:text-stoklabel-900 dark:text-stoklabel-400 dark:hover:text-stoklabel-300 transition-colors duration-150"
                        title="Edit"
                      >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 bg-white dark:bg-slate-700 border border-gray-300 dark:border-slate-600 rounded-lg text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-stoklabel-500 dark:focus:ring-stoklabel-400 focus:border-transparent transition-all duration-200"
                  required
                >
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="rounded border-gray-300 dark:border-slate-600 text-stoklabel-600 focus:ring-stoklabel-500"
                />
