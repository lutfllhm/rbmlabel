                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`block w-full pl-12 pr-4 py-3.5 bg-slate-900/50 border-2 rounded-xl text-white placeholder-slate-500 focus:outline-none transition-all duration-300 ${
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`block w-full pl-12 pr-12 py-3.5 bg-slate-900/50 border-2 rounded-xl text-white placeholder-slate-500 focus:outline-none transition-all duration-300 ${
